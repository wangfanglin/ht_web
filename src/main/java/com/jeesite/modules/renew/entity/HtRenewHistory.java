 ...
 * @version 2020-03-25
 */
@Table(name="ht_renew_history", alias="a", columns={
		@Column(name="id", attrName="id", label="id", isPK=true),
		@Column(name="manage_status", attrName="manageStatus", label="处理状态"),
		@Column(name="task_remarks", attrName="taskRemarks", label="环节说明", queryType=QueryType.LIKE),
		...
		@Column(name="image", attrName="image", label="相关图片"),
...
public class HtRenewHistory extends DataEntity<HtRenewHistory> {
	
	private static final long serialVersionUID = 1L;
	private String manageStatus;		// 处理状态

	private String taskRemarks;		// 环节说明
	...
	private String smsModel;		// 短信模板内容


	public HtRenewHistory() {
		this(null);
	}

	public HtRenewHistory(String id){
		super(id);
	}
	
	@Length(min=0, max=255, message="环节说明长度不能超过 255 个字符")
