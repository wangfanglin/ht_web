 ...
 * @version 2020-02-27
 */
@Table(name="ht_repair_offer_part", alias="a", columns={
...
public class HtRepairOfferPart extends DataEntity<HtRepairOfferPart> {
	...
	public HtRepairOfferPart() {
		this(null);
	}

	public HtRepairOfferPart(String id){
		super(id);
	}
