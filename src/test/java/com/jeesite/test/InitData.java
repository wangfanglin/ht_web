...
import com.jeesite.modules.bpm.db.InitBpmData;
...
public class InitData extends BaseInitDataTests {
	...
	@Test
	public void initStep03() throws Exception{
		initBpmData();			// 业务流程模块
	}
	...
	public void initBpmData() throws Exception{
		InitBpmData data = SpringUtils.getBean(InitBpmData.class);
		data.createTable();
		data.initBpmCategory();
		data.initBpmForm();
		data.initBpmEvent();
		data.initBpmScript();
	}
